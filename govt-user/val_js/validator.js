...
var validator = (function($){
    ...
    */
    message = {
        ...
        repeat          : 'No match',
        chars           : 'Enter Character Only',
        mobs            : 'Enter 10-Digit Mobile Number',
        numbs           : 'Only Characters And Numbers Allowed',
        complete        : 'Input Is Not Complete',
								pincode									:	'Pincode Must Be Six Digit',
        ...
        text : function(a, skip){
            ...
            if( pattern ){
                ...
                switch( pattern ){
                    ...
                    case 'alpha' :
                        regex=/^[a-z A-Z ]+$/i;
                        alertTxt = message.chars;
                        break;
                    case 'mob' :
                        regex= /^\+?([0-9]{10})+$/i;
                        alertTxt = message.mobs;
                        break;
                    case 'email' :
                        regex=/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;
                        alertTxt=message.email;
                        break;
																		case 'pincode' :
                        regex=/^[1-9][0-9]{5}$/i;
                        alertTxt=message.pincode;
                        break;
																				case 'password' :
                        regex=/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$/i;
                        alertTxt=message.password;
                        break;
