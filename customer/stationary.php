...
$sql1 ="select * from product_category where product_category_name='Stationary Materials'";
...
{
    ?>
								<div class="col-md-4 col-sm-6 col-xs-12 col-product">		
									<div class="sv-item-img">
										<div class="sv-img-holder">
											<img src="../admin/images/<?php echo $row['product_details_image']; ?>" alt="image">
										</div>
										<!--<div class="sv-tag">
											<span>new</span>
										</div>-->
										<div class="sv-box-hover">
											<a href="../admin/images/<?php echo $row['product_details_image']; ?>" data-lightbox="product-1">
									...
									<div class="sv-block-item-title">
								    	...
								    	<form action="customer_cart_insert.php" method="post">
								    	<?php $row1=100; ?>
										...
										<button type="button" class="btn btn-success" onclick="window.location.href='stationaryproduct.php?id=<?php echo $row['product_details_id']; ?>' "><i class="fa fa-eye"></i> View Details</button>
