	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php 
                        ...
                        $sql="select * from customer_details where customer_details_username='$uname'";
                        $res=mysqli_query($conn,$sql);
                        $row=mysqli_fetch_array($res,MYSQLI_ASSOC);
                       // $customer_details_name=$row['customer_details_name'];
                        ?>
						...
						<form class="sv-contact-form" action="feedback_insert.php" method="post" novalidate>
							<fieldset>
								<div class="form-group item">
									<input type="text" placeholder="Name" class="form-control" pattern="alpha"  name="feedback_name" id="feedback_name" required="required" readonly value="<?php echo $row['customer_details_name']; ?>">
								</div>
								<div class="form-group item">
