						...
						<div class="col-md-12 col-xs-12 sv-product-image-holder">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                   <thead>
                                        <tr align="left">
                                            <td colspan="6" align="center"><h1><b>Cart List</b></h1></td>                                            
					               ...
					               while($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
					               {
                                    ...
                                    ?>                                      
                                        <tr align="left">
                                            ...
                                            <input type="hidden" name="customer_order_id" id="customer_order_idcustomer_order_id" value="<?php echo $row['customer_order_id'];?>" size="1" class="form-control">
                                            
                                            <input type="hidden" name="customer_order_price" id="customer_order_price" value="<?php echo $row['customer_order_price'];?>" size="1" class="form-control">
                                            
                                            <input type="text" name="customer_order_quantity" id="customer_order_quantity" value="<?php echo $row['customer_order_quantity'];?>" size="1" class="form-control">
                                            ...
                                            <td align="left">
                                            <button type="button" onclick="window.location.href='cart_delete.php?id=<?php echo $row['customer_order_id'];?>' " class="btn btn-success"><i class="fa fa-trash-o"></i></button>
				...
				<div class="col-md-4 col-sm-5 col-xs-12">
					...
					<!--- side bar starts-->
						<div class="main-block1">
                            ...
                            <div class="table-responsive">
                            <h2 style="padding-bottom:10px;"><b>Order Summary</b></h2>
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="total">
                                      ...
                                      <th>
                                       <a href="books.php" class="btn btn-success">Continue Order...</a>
                                      </th>
                                ...
                                { ?>
                                     ...
                                     <th>
                                     <a href="customer_cart_update.php?customer_details_id=<?php echo $cust_id;?>&customer_order_id=<?php echo $cust_order_id;?>&sgst=<?php echo $sgst;?>&cgst=<?php echo $cgst;?>&total=<?php echo $total_amount;?>&customer_order_status=<?php echo  $cust_order_status; ?>"class="btn btn-success">Place Order</a>
