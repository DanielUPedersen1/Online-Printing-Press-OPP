								...
								<div class="col-md-3 col-sm-6 col-xs-12 col-product">		
									<div class="sv-item-img">
										...
										<div class="sv-box-hover">
											<a href="admin/photos/<?php echo $row['product_details_image']; ?>" data-lightbox="product-1" height="250" width="400">
									...
									<div class="sv-block-item-title">
										...
										<!--<a href="#" class="product-button">add to cart</a>-->
										 <button type="button" class="btn btn-success" onclick="window.location.href='login.php' "><i class="fa fa-shopping-cart"></i> Add to Cart</button>
