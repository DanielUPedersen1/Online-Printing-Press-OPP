        ...
        <?php
            ...
            $d=date("d-m-Y");
             ...
             $customer_id=$_REQUEST['id'];
                $order_date=$_REQUEST['d'];
            $customer_order_no=$_REQUEST['o'];

                ?>

<strong>Date :</strong> <strong style="font-family:Agency FB; font-weight:bold"><?php echo $d; ?></strong><br>
<h2 align="right">Order Date :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $order_date; ?></h2>
<h2 align="right">Order No. :&nbsp;&nbsp;&nbsp;<?php echo $customer_order_no; ?></h2>
           ...
           //$order_date=date("d-m-Y",$order_date1);
            ...
            $sql11="SELECT  * FROM customer_order WHERE customer_details_id='$customer_id' and customer_order_date='$order_date' and customer_order_status='orderplaced' and customer_order_no='$customer_order_no' ";
            $result1=mysqli_query($conn,$sql11);
            $row11=mysqli_fetch_array($result1,MYSQLI_ASSOC);
            
            $order_date=$row11['customer_order_date'];


                $sql4="SELECT * FROM customer_details where customer_details_id='$customer_id' ";
            ...
            <table id="meta" style="float:left;">
              <!-- <tr>
                ...
                <tr>
                    ...
                    <td><?php echo $row4['customer_details_name'];?></td>
                </tr>
                <tr>

                    <td class="meta-head">Contact No.</td>
                    <td style="font-family:Times New Roman;"><?php echo $row4['customer_details_contact'];?></td>
                </tr>
                <tr>
                    <td class="meta-head">Address</td>
                    <td><div class="due"><?php echo $row4['customer_details_address'];?><br>
                    </div></td>
                </tr>
        ...
        <table id="items">
            ...
            $sql = "select * from customer_order co,product_details pd  where co.customer_details_id='$customer_id' and co.customer_order_date='$order_date' and co.product_details_id=pd.product_details_id  and co.customer_order_status='orderplaced' and co.customer_order_no='$customer_order_no' ";
       ...
       $result = mysqli_query($conn,$sql);
            ...
            {
                $r=$row1['customer_order_price'];
                $q=$row1['customer_order_quantity'];
                $to1=$r*$q;
                $to+=$r*$q;
                //$tot=$tot+$to;
            ...
            <tr class="item-row">
                ...
                <td align="center" class="description" style="font-family:Cambria; font-size:16px"><?php echo $row1['customer_order_quantity']; ?></td>

                <td align="center" class="description" style="font-family:Cambria; font-size:16px"><?php echo $row1['customer_order_price']; ?></td>
        ...
        <div id="terms">
          ...
          <button id="printpage" onclick="window.location.href='customer_order_view.php'"><strong>Cancel</strong></button>
