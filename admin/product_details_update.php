...
if (empty($product_details_image)) 
  	{
			$product_details_image=$_POST['oldphoto'];
	}
...
//{
   //echo '<script type="text/javascript">
	...
	//window.location="product_details_edit_form.php";
	//</script>';
//}
...
$sql = 'UPDATE `product_details` SET 
 ...
 `product_details_quantity`='."'$product_details_quantity'".',
