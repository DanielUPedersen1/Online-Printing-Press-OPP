...
<?php require('db_connect.php');
    ...
    $govt_user_id=$_REQUEST['id1'];     
                            
   /* $order_delivery_status=$_REQUEST['status']; */
...
<input type="hidden" name="bill_details_id" id="bill_details_id" value="<?php echo $bill_details_id; ?>" > 

<input type="hidden" name="govt_user_id" id="govt_user_id" value="<?php echo $govt_user_id; ?>" >                 
